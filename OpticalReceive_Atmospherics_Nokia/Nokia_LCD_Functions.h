...
static const byte ASCII[][5] = {
  ...
  ,{0x02, 0x04, 0x08, 0x10, 0x20} // 5c <backslash> /* needed to remove the actual backslash as it was causing commenting / off-by-one-issues. -JA */
...
/*
Reducing Arduino memory load but leaving this here as a good test example.
